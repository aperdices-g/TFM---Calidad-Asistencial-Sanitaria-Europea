...
gasto_f$Value<-substr(gasto_f$Value,1,nchar(gasto_f$Value)-3)
...
* Observamos que tenemos **568 valores perdidos**.Guardamos en la variable **idx** los índices de los registros con valores **NA** de la variable **Value**.
