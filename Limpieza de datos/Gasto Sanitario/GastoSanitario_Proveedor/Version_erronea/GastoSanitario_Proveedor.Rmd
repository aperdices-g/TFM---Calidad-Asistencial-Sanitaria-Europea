...
gasto_pro$Value<-substr(gasto_pro$Value,1,nchar(gasto_pro$Value)-3)
...
* Observamos que tenemos **731 valores perdidos**.Guardamos en la variable **idx** los índices de los registros con valores **NA** de la variable **Value**.
