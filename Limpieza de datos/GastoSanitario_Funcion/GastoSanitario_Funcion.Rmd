...
gasto_fun$Value<-substr(gasto_fun$Value,1,nchar(gasto_fun$Value)-3)
...
* Observamos que tenemos **632 valores perdidos**.Guardamos en la variable **idx** los índices de los registros con valores **NA** de la variable **Value**.
